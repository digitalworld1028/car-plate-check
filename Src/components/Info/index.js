...
const Info = (props) => {
    ...
    return (
        <View>
            ...
            {type !== 'motorycle' && <Single type={'extintor'} text1={'EXTINTOR'} text2={'VENCIMIENTO:'} text3={extintor} text4={range4 >= 0 ? 'VIGENCIA ' + (10 - range4) + ' DÍAS' : (-range4) + ' DÍAS VENCIDO'} status={status4} range={range4} firstLine={{ color: '#1A1C20' }} />}
        </View>
    )
};
